...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScoreSummary.highest'
        db.alter_column('submissions_scoresummary', 'highest_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['submissions.Score']))

    def backwards(self, orm):

        # Changing field 'ScoreSummary.highest'
        db.alter_column('submissions_scoresummary', 'highest_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['submissions.Score']))
    ...
    models = {
        ...
        'submissions.scoresummary': {
            ...
            'highest': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['submissions.Score']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
